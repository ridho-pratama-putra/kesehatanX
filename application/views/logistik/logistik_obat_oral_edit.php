...
<form method="POST" action="<?=base_url()?>logistik-obat-oral-submit-edit">
	...
	<div class="container mt-3">
		...
		<div class="form-group">
			...
			<input type="number" min="0" class="form-control" id="hargaBeliSatuan" placeholder="Contoh : 7500 atau 0 (Negative)" name="satuan_per_box" value="<?=$record[0]->satuan_per_box?>" required="">
		</div>
		<div class="form-group">
			<label for="hargaJualSatuan">
				Harga Beli per Box
			</label>
			<input type="number" min="0" class="form-control" id="hargaJualSatuan" placeholder="Contoh : 11000 atau 0 (Negative)" name="harga_beli_per_box" value="<?=$record[0]->harga_beli_per_box?>" required="">
		</div>
		<div class="form-group">
			<label for="hargaJualSatuan">
				Harga Jual Satuan

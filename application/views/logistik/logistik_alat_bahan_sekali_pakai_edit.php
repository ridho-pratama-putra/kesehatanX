...
<form method="POST" action="<?=base_url()?>logistik-alat-bahan-sekali-pakai-submit-edit">
	...
	<div class="container mt-3">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="tambahBahan" placeholder="Contoh : Silk 2/0 + Jarum" name="nama" value="<?=$record[0]->nama?>" required="">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="provider" placeholder="Contoh : IHS Medikom" name="provider" value="<?=$record[0]->provider?>" required="">
		</div>
		<div class="form-group">
			<label for="bentuk">
				Bentuk
